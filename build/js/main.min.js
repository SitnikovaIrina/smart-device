...
let { fileURLToPath, pathToFileURL } = __webpack_require__(/*! url */ 3)
let { resolve, isAbsolute } = __webpack_require__(/*! path */ 2)
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(/*! source-map-js */ 1)
let { dirname, resolve, relative, sep } = __webpack_require__(/*! path */ 2)
let { pathToFileURL } = __webpack_require__(/*! url */ 3)
...
let { dirname, join } = __webpack_require__(/*! path */ 2)
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var phoneInput = document.querySelectorAll('input[data-phone-input]');
  var NUMBER_LENGTH = 11;
  var checkInputPhone = function checkInputPhone() {
    phoneInput.forEach(function (item) {
      item.addEventListener('input', function () {
        ...
        var result = '';
        for (var i = 0; i < value.length && i < NUMBER_LENGTH; i++) {
          switch (i) {
            case 0:
  ...
  var phone = document.querySelector('[name=tel]');
  ...
  var modalUsername = document.querySelector('[name=modal-name]');
  var modalPhone = document.querySelector('[name=modal-tel]');
  var modalPform = document.querySelector('#modal-callback-form');
  ...
  accordionItems.forEach(function (item) {
    ...
    var icon = item.querySelector('[data-accordion-button-icon]');
...
/* harmony import */ var postcss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! postcss */ "../node_modules/postcss/lib/postcss.js");
